...
def add_multi_options(parser):
    ...
    group.add_argument("--pretrained_path", default='/workspace/priorMD/temporary_folder/MDM/model000280000.pt', type=str,
    ...
    group.add_argument("--multi_train_mode", default='text', choices=['prefix', 'text'], type=str, help="")
...
def add_sampling_options(parser):
    ...
    group.add_argument("--model_path", required=False, default="/workspace/priorMD/temporary_folder/test_our_chatgptData/model000300005.pt", type=str,
                       help="Path to model####.pt file to be sampled.")
...
def add_generate_options(parser):
    ...
    group.add_argument("--text_prompt", default="Before meeting a client, the man parts with the woman.", type=str,
